...
class ServiceController extends Controller
{
    ...
    public function uploadFile(Request $request){
        ...
        if($request->hasFile('file')){
            ...
            // guardo la filen en \storage\app\public\***** (previo correr php artisan storage:link para que genere el syslink)
            $path = $file->storeAs('public/' . $archive, $filename);

            // devuelvo la url de la filen (en caso de local es facil, agrega el "storage", pero si fuera bucket u otra cosa, devuelve url real)
            $url = Storage::url($path);
