                                ...
                                <tbody>
                                    @foreach ($items as $i)
                                        <tr>
                                            <td>{{$i->name}}</td>
                                            <td>{{$i->email}}</td>                                
                                            <td>{{$i->isGod()?'Superadmin':$i->commaProfiles()}}</td>                                
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="{{route('admin.user.edit', ['id' => $i->id])}}" class="btn btn-sm btn-secondary js-tooltip-enabled" data-toggle="tooltip" title="Editar" data-original-title="Edit">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a href="{{route('admin.user.password', ['id' => $i->id])}}" class="btn btn-sm btn-secondary js-tooltip-enabled" data-toggle="tooltip" title="Cambiar Contraseña" data-original-title="Cambiar Contraseña">
                                                        <i class="fa fa-lock"></i>
                                                    </a>
                                                    <a href="{{route('admin.user.delete', ['id' => $i->id])}}" class="btn btn-sm btn-secondary btn-delete js-tooltip-enabled" data-toggle="tooltip" title="Eliminar" data-original-title="Delete" data-id="{{ $i->id }}">
